...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'console.command.public_alias.App\\Command\\ImportCommand' => 'getImportCommandService',
    ...
    protected function getBasketControllerService()
    {
        ...
        $this->services['App\\Controller\\BasketController'] = $instance = new \App\Controller\BasketController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\BasketController', $this));
    ...
    protected function getTranslationControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\TranslationController', $this));
    ...
    /**
     * Gets the public 'console.command.public_alias.App\Command\ImportCommand' shared autowired service.
     *
    ...
    protected function getImportCommandService()
    {
        ...
        return $this->services['console.command.public_alias.App\\Command\\ImportCommand'] = new \App\Command\ImportCommand();
    }
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Command\\ImportCommand' => ['services', 'console.command.public_alias.App\\Command\\ImportCommand', 'getImportCommandService', false],
            'App\\DataFixtures\\ProductFixture' => ['privates', 'App\\DataFixtures\\ProductFixture', 'getProductFixtureService', false],
            'App\\DataFixtures\\UserFixtures' => ['privates', 'App\\DataFixtures\\UserFixtures', 'getUserFixturesService', false],
            'App\\EventSubscriber\\LocaleSubscriber' => ['privates', 'App\\EventSubscriber\\LocaleSubscriber', 'getLocaleSubscriberService', false],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.tJh0hLe', 'get_ServiceLocator_TJh0hLeService', false],
            ...
            'fragment.renderer.esi' => ['privates', 'fragment.renderer.esi', 'getFragment_Renderer_EsiService', false],
    ...
    /**
     * Gets the private '.service_locator.tJh0hLe' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_TJh0hLeService()
    {
        return $this->privates['.service_locator.tJh0hLe'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ProductController::index' => ['privates', '.service_locator.n8gOTNr', 'get_ServiceLocator_N8gOTNrService', false],
    ...
    /**
     * Gets the private 'App\DataFixtures\ProductFixture' shared autowired service.
     *
     * @return \App\DataFixtures\ProductFixture
     */
    protected function getProductFixtureService()
    {
    ...
    {
        return $this->privates['App\\EventSubscriber\\LocaleSubscriber'] = new \App\EventSubscriber\LocaleSubscriber();
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qH+m7iJf9F', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iTIYFoLi3B', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.easyadmin.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JsAsgg+tvh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7P8+wHurBc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nJz6kdk8HE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SwCa+fvZ-j', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F+wmwxuWww', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t5Zy2XbfJl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.webpack_encore.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DgoNMX1s6h', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedController_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.tJh0hLe'] ?? $this->get_ServiceLocator_TJh0hLeService()));
    }
    ...
    protected function getDebug_ArgumentResolver_Service_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.service.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(($this->privates['.service_locator.tJh0hLe'] ?? $this->get_ServiceLocator_TJh0hLeService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.clean.product_images'] ?? $this->getVichUploader_Listener_Clean_ProductImagesService()));
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.remove.product_images'] ?? $this->getVichUploader_Listener_Remove_ProductImagesService()));
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.upload.product_images'] ?? $this->getVichUploader_Listener_Upload_ProductImagesService()));
        $instance->addEventSubscriber(($this->privates['stof_doctrine_extensions.listener.sluggable'] ?? $this->getStofDoctrineExtensions_Listener_SluggableService()));
    ...
    protected function getDoctrine_Fixtures_LoaderService()
    {
        ...
        $instance->addFixtures([0 => ['fixture' => ($this->privates['App\\DataFixtures\\ProductFixture'] ?? ($this->privates['App\\DataFixtures\\ProductFixture'] = new \App\DataFixtures\ProductFixture())), 'groups' => []], 1 => ['fixture' => ($this->privates['App\\DataFixtures\\UserFixtures'] ?? $this->getUserFixturesService()), 'groups' => []]]);
    ...
    protected function getSecurity_Firewall_Map_Config_MainService()
    {
        ...
        return $this->privates['security.firewall.map.config.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.app_user_provider', 'main', 'App\\Security\\LoginFormAuthenticator', NULL, NULL, [0 => 'guard', 1 => 'anonymous'], NULL);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.App\\Command\\ImportCommand',
            ],
        ];
    }
