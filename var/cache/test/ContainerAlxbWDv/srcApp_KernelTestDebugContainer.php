...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.BanRksc', 'get_ServiceLocator_BanRkscService', false],
    ...
    /**
     * Gets the private '.service_locator.BanRksc' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_BanRkscService()
    {
        return $this->privates['.service_locator.BanRksc'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getDebug_ArgumentResolver_NotTaggedController_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.BanRksc'] ?? $this->get_ServiceLocator_BanRkscService()));
    }
    ...
    protected function getDebug_ArgumentResolver_Service_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.service.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(($this->privates['.service_locator.BanRksc'] ?? $this->get_ServiceLocator_BanRkscService()));
    }
    ...
    protected function getDoctrine_Fixtures_LoaderService()
    {
        ...
        $instance->addFixtures([0 => ['fixture' => ($this->privates['App\\DataFixtures\\AppFixtures'] ?? ($this->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []], 1 => ['fixture' => ($this->privates['App\\DataFixtures\\ProductFixture'] ?? ($this->privates['App\\DataFixtures\\ProductFixture'] = new \App\DataFixtures\ProductFixture())), 'groups' => []]]);
