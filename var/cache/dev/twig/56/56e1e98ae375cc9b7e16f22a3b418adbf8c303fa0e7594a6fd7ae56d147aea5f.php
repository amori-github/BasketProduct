...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/opt/lampp/htdocs/BasketProduct/website-skeleton/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
