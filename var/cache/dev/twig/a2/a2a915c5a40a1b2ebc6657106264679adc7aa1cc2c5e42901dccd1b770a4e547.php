...
class __TwigTemplate_6346554cf005832591e270304c3d4ee7c8c4917c4da8d1423ebdeeecf4e25b37 extends Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/opt/lampp/htdocs/BasketProduct/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
