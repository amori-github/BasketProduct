...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/opt/lampp/htdocs/BasketProduct/website-skeleton/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
