...
class __TwigTemplate_bcfc67d4527ed0f3bfd6c4aee05a636c53e36aa4035a647b5513dbb2929f0980 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/opt/lampp/htdocs/BasketProduct/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
