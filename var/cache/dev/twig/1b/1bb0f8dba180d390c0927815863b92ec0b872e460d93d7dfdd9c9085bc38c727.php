...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "/opt/lampp/htdocs/BasketProduct/website-skeleton/vendor/symfony/web-profiler-bundle/Resources/views/Collector/mailer.html.twig");
    }
}
